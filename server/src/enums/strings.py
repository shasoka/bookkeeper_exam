...
class Messages(StrEnum):
    ...
    ON_THEME_CHOSEN: Final[str] = "⚰️ Ставки сделаны, ставок больше нет... или есть?\nВы выбрали %s.\n❔ Вопросов в этой теме: %s. \nКнопки говорят сами за себя. Удачи."
    ...
    ON_EXAM_END: Final[str] = f"""
        ...
        """
    EXAM_RECORD: Final[str] = "Так уж и быть, обрадую. Ты побил свой предыдущий рекорд! ✳️"
    EXAM_NOT_RECORD: Final[str] = "Даже лучшие порой ошибаются... Но это тоже хороший результат! *️⃣"
    ...
    ON_QUIZ_END_SUCCESS: Final[str] = f"""
